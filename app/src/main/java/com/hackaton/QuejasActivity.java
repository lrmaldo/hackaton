...
public class QuejasActivity extends AppCompatActivity implements PostsFragment.OnPostSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     final String TAG = "QuejasActivity";
    ...
    mFab.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (user == null || user.isAnonymous()) {
                Toast.makeText(QuejasActivity.this, "tu no te has logeado...", Toast.LENGTH_SHORT).show();
                return;
            }
            Intent newPostIntent = new Intent(QuejasActivity.this, NuevaQuejaActivity.class);
    ...
    public void onPostComment(String postKey) {
        ...
        intent.putExtra(ComentariosActivity.POST_KEY_EXTRA, postKey);
